...
def test_load_without_dataset(sandbox_configuration):
    test_data_location = Path(__file__).parent / 'resources' / 'datasets' / 'basic' / 'data' / 'main_chamber_cut_0.fits'

    data = load_without_dataset(file=test_data_location, location='ALG-MC')
