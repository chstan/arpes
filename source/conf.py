...
latex_documents = [
    (master_doc, 'python-arpes.tex', 'python-arpes Documentation',
     'Conrad Stansbury', 'manual'),
]
...
man_pages = [
    (master_doc, 'python-arpes', 'python-arpes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python-arpes', 'python-arpes Documentation',
     author, 'python-arpes', 'One line description of project.',
     'Miscellaneous'),
]
